...
using Kpi.Allo.ClientTests.Model.Platform.Client;
using Kpi.Allo.ClientTests.Model.Platform.Communication;
using Kpi.Allo.ClientTests.Platform.Communication.Http;
using RestSharp;
using Serilog;

namespace Kpi.Allo.ClientTests.Platform.Client
{
