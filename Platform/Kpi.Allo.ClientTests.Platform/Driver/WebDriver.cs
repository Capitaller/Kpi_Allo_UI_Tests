...
using Kpi.Allo.ClientTests.Platform.Enum;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using OpenQA.Selenium.Remote;
using Serilog;
using IJavaScriptExecutor = Kpi.Allo.ClientTests.Model.Platform.Drivers.IJavaScriptExecutor;

namespace Kpi.Allo.ClientTests.Platform.Driver
{
